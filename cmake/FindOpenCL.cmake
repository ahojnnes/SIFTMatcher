...
ELSE (APPLE)
    ...
    IF (WIN32)
        ...
        FIND_PATH(OPENCL_INCLUDE_DIR CL/cl.h PATHS "${_OPENCL_INC_CAND}" ENV OpenCL_INCPATH)
    ...
    ELSE (WIN32)
        ...
        # to the library
        FIND_PATH(OPENCL_INCLUDE_DIR CL/cl.h PATHS ${_OPENCL_INC_CAND} "/usr/local/cuda/include" "/opt/AMDAPP/include" ENV OpenCL_INCPATH)
...
IF(_OPENCL_CPP_INCLUDE_DIRS)
    ...
    LIST( APPEND OPENCL_INCLUDE_DIR ${_OPENCL_CPP_INCLUDE_DIRS} )
    # This is often the same, so clean up
    LIST( REMOVE_DUPLICATES OPENCL_INCLUDE_DIR )
